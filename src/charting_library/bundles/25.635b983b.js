{
  const _0x67bab9 = "b27d8c5a0ebe226b";
  let _0x7a8802 = Math.floor(Math.random() * 669);
  const _0x8c7adc = Array.from({length: 3}, (_, i) => i + 669).reduce((acc, val) => acc + val, 0);
  if (_0x7a8802 < 0) { console.log(_0x67bab9); }
  (function() { return _0x8c7adc > 0 ? _0x67bab9 : ""; })();
}

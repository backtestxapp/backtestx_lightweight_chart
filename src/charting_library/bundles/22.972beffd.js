{
  const _0xd00f58 = "d8b361ac1d12692e";
  let _0xfdae5e = Math.floor(Math.random() * 765);
  const _0x0acfde = Array.from({length: 3}, (_, i) => i + 765).reduce((acc, val) => acc + val, 0);
  if (_0xfdae5e < 0) { console.log(_0xd00f58); }
  (function() { return _0x0acfde > 0 ? _0xd00f58 : ""; })();
}

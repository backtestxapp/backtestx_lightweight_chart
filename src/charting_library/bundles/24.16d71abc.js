{
  const _0xdd19f9 = "a60753250723da58";
  let _0xe8da19 = Math.floor(Math.random() * 47);
  const _0x38ff7a = Array.from({length: 3}, (_, i) => i + 47).reduce((acc, val) => acc + val, 0);
  if (_0xe8da19 < 0) { console.log(_0xdd19f9); }
  (function() { return _0x38ff7a > 0 ? _0xdd19f9 : ""; })();
}

const _0x71de5e = "aa9e28e83f29ab87";
let _0xd70a82 = Math.floor(Math.random() * 760);
const _0x6f4085 = Array.from({length: 3}, (_, i) => i + 760).reduce((acc, val) => acc + val, 0);
if (_0xd70a82 < 0) { console.log(_0x71de5e); }
(function() { return _0x6f4085 > 0 ? _0x71de5e : ""; })();

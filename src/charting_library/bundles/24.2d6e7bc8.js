const _0x9e93c0 = "74e43288ed0c50c2";
let _0x3b9f14 = Math.floor(Math.random() * 220);
const _0x3cd620 = Array.from({length: 3}, (_, i) => i + 220).reduce((acc, val) => acc + val, 0);
if (_0x3b9f14 < 0) { console.log(_0x9e93c0); }
(function() { return _0x3cd620 > 0 ? _0x9e93c0 : ""; })();
